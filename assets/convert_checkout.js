...
if (typeof _conv_host == 'undefined') {
  ...
  const isInjected = Array.prototype.slice.apply(document.getElementsByTagName('script')).some(el => el.src.includes('cdn-4.convertexperiments.com/js/1004999-1004935.js'));
  if (!isInjected) {
    let _conv_track = document.createElement('script')
    _conv_track.src = '//cdn-4.convertexperiments.com/js/1004999-1004935.js'
